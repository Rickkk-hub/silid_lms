...
export default function GradesHeader({ setSidebarOpen }) {
    ...
    <header className="sticky top-0 z-30 bg-[#F1F5F0] px-4 md:px-10 py-6 flex items-center justify-between border-b border-slate-200/50 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex p-3 rounded-2xl shadow-lg shadow-emerald-900/20 bg-white border border-slate-50 text-[#3a947e]">
            <LayoutDashboard size={24} />
          </div>
          <div className="flex flex-col">
            <h1 className="text-2xl md:text-3xl font-serif font-bold text-slate-800 tracking-tight leading-none">
              Portal
            </h1>
            <p className="text-[10px] text-[#3a947e] font-black uppercase tracking-[0.2em] mt-1 italic opacity-70">
              Assigned Instructor Load
            </p>
          </div>
        </div>
      </div>
